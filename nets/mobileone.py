...
PARAMS = {
    "t0": {"width_multipliers": (0.25, 0.25, 0.25, 0.25), "num_conv_branches": 4},
    "t1": {"width_multipliers": (0.375, 0.375, 0.375, 0.375), "num_conv_branches": 4},
    "t2": {"width_multipliers": (0.5, 0.5, 0.5, 0.5), "num_conv_branches": 4},
    "t3": {"width_multipliers": (0.75, 0.75, 0.75, 0.75), "num_conv_branches": 4},
...
if __name__ == '__main__':
    net = mobileone(num_classes=212, inference_mode=True, variant='t3')
