...
__all__ = ['max_vit_tiny_224', 'max_vit_small_224', 'max_vit_base_224', 'max_vit_large_224']
...
class MaxViT(nn.Module):
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        output = self.forward_head(output.float() if self.fp16 else output)
        return output
...
if __name__ == '__main__':
    ...
    def test_networks() -> None:
        ...
        for get_network in [max_vit_large_224]:
